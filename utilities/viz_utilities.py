...
def plot_history(history, use_skew=True, use_kurt=True, use_rich=True):
    ...
    learn_history.plot(x='epoch',y='cm_loss', ax=ax[1,0])
    learn_history.plot(x='epoch',y='val_cm_loss', ax=ax[1,0])
    learn_history.plot(x='epoch',y='cstd_loss', ax=ax[1,1])
    learn_history.plot(x='epoch',y='val_cstd_loss', ax=ax[1,1])
    ...
    learn_history.plot(x='epoch',y='cm_r_square', ax=ax[1,0])
    learn_history.plot(x='epoch',y='val_cm_r_square', ax=ax[1,0])   
    
    learn_history.plot(x='epoch',y='cstd_r_square', ax=ax[1,1])
    learn_history.plot(x='epoch',y='val_cstd_r_square', ax=ax[1,1]) 
